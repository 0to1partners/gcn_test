...
from dataset.pop_sequence import LifePopHourlyModule
...
if __name__ == '__main__':
    ...
    args = {
        ...
        'adj_hidden_dim': 32,  # 인접 행렬 임베딩 차원
    ...
    data_module = LifePopHourlyModule(data, add_data=add_data, pred_len=args['pred_len'],
                                      validation_rate=0.2, seq_len=args['seq_len'],
                                      batch_size=args['batch_size'], num_workers=4)

    logger = TensorBoardLogger('lightning_logs', name='seq_baseline')
